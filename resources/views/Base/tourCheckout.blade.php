                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row" class="border-0">
                                            <div class="p-3">
                                                <img src="{{ asset('uploads/Tour/' . $tour->image) }}" alt="Tour Image"
                                                    width="200" class="img-fluid rounded shadow-sm">
                                                <div class="ml-3 d-inline-block align-middle">
                                                    <h1 class="mb-0">
                                                        <a href="#"
                                                            class="text-dark d-inline-block align-middle">{{ $tour->tour_name }}</a>
                                                    </h1>
                                                    <span
                                                        class="text-muted font-weight-normal font-italic d-block">Description:
                                                        {{ $tour->description }}</span>
                                                    <span class="text-muted font-weight-normal font-italic d-block">Phone:
                                                        {{ $phone }}</span>
                                                    <span class="text-muted font-weight-normal font-italic d-block">Email:
                                                        {{ $email }}</span>
                                        ...
                                        <td class="border-0 align-middle">
                                            <strong
                                                class="larger-text text-black">${{ number_format($tour->budget, 2) }}</strong>
                                        </td>
                                        <td class="border-0 align-middle">
                                            <strong class="larger-text text-black">{{ $total_days }}</strong>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="row py-5 p-4 bg-white rounded shadow-sm text-black">
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            ...
                            <form action="{{ route('tour.checkout.payment') }}" method="POST">
                                @csrf
