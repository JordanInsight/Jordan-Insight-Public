                ...
                <div class="wrapper">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="input-box">
                            ...
                            <i class='bx bx-show' onclick="togglePasswordVisibility()"></i>
                            @error('password')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="register-link">
                            <p>Dont have an account? <a href="javascript:void(0);" onclick="goToRegisterForm()">Register
                                    Here</a>
                            </p>
                        </div>
                    </form>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        function togglePasswordVisibility() {
            ...
            var toggleIcon = document.querySelector('.bx');
        ...
        window.togglePasswordVisibility = togglePasswordVisibility; // Make the function globally available
    });
</script>
