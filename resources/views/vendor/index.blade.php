...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="detailsUpdate" method="POST" action="/vendor/profile/{{ $user->id }}/update"
            ...
            <div class="modal-content">
                <form id="changePasswordForm" action="{{ route('user.profile.update.password', ['user' => Auth::id()]) }}"
                    ...
                    <div class="modal-header">
                        <h5 style="font-family: inherit;" class="modal-title" id="profilePicModalLabel">Change
                            Password </h5>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Form Submission with AJAX for details update
            ...
            $('#profileImageInput').change(function() {
                if ($(this)[0].files.length > 0) { // Make sure a file was selected
                    ...
                    $.ajax({
                        url: "{{ route('vendor.profile.upload-image', $user) }}",
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
